...
<body>
    ...
    <nav class="sidebar">
        ...
        <div class="nav flex-column gap-1">
            ...
            <a href="<?= BASE_URL ?>/admin/hasil_kuisioner" class="nav-link active">
    ...
    <main class="main-content">
        ...
        <div class="card-clean p-4 mb-4">
            ...
            <div class="border-top mt-3 pt-3">
                <form method="POST" action="<?= BASE_URL ?>/admin/export_data" target="_blank" class="d-flex flex-wrap align-items-center gap-3">
                    <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
