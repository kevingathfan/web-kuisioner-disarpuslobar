...
<head>
    ...
    <title>Reset Password - Dinas Kearsipan dan Perpustakaan</title>
...
<body class="d-flex align-items-center justify-content-center min-vh-100 bg-light">
    ...
    <div class="card-clean p-4 p-md-5 shadow-lg" style="max-width: 450px; width: 100%; background: #fff;">
        <div class="text-center mb-4">
            ...
            <h4 class="fw-extrabold mb-1 text-dark">RESET PASSWORD</h4>
            <p class="text-muted small mb-0">Masukkan password baru Anda di bawah ini.</p>
        </div>

        <?php if(!empty($pesan) && !$success): ?>
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="password" name="password" class="form-control border-start-0 ps-0" placeholder="Password baru..." required autofocus>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="password" name="confirm" class="form-control border-start-0 ps-0" placeholder="Ulangi password..." required>
                </div>
            </div>
