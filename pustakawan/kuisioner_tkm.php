...
// --- Fetch section data for sidebar ---
...
$stmtTotal = $pdo->prepare("SELECT COUNT(*) FROM master_pertanyaan WHERE jenis_kuesioner = 'TKM'");
$stmtTotal->execute();
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Survei TKM — Disarpus Lombok Barat</title>
    <meta name="description" content="Survei Tingkat Kegemaran Membaca (TKM) — Pendataan literasi masyarakat Kabupaten Lombok Barat.">
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css">
    <link rel="stylesheet" href="../assets/loader.css">
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; outline: none; }
        ...
        .sv-nav-item.completed .sv-nav-progress-fill {
            background: #10B981;
        }
        .sv-nav-item.completed .sv-nav-icon {
            background: #ECFDF5;
            color: #10B981;
        }
        ...
        @media (max-width: 1024px) {
            ...
            body.sidebar-open .sv-sidebar-backdrop {
                display: block;
            }
        }
...
<body>
    ...
    <nav class="sv-navbar">
        <div class="wrapper">
            <a href="../index.php" class="sv-brand">
            ...
            <div class="sv-nav-actions">
                <a href="../index.php#footer-map" class="sv-nav-btn sv-nav-btn-outline">
                    <i class="bi bi-geo-alt-fill"></i> <span>Kunjungi Kami</span>
                </a>
                <a href="form_pengaduan.php" class="sv-nav-btn sv-nav-btn-primary">
    ...
    <section class="sv-hero">
        <div class="sv-hero-card">
            <div class="sv-hero-info">
                <h1>Survei Tingkat Kegemaran Membaca (TKM)</h1>
                <p class="sv-hero-sub">Pendataan literasi masyarakat<br>Kabupaten Lombok Barat <?= date('Y') ?></p>
        ...
        <aside class="sv-sidebar" id="survSidebar">
            ...
            <div class="sv-sidebar-card">
                <div class="sv-help-box">
                    ...
                    <a href="form_pengaduan.php" class="sv-help-btn">
    ...
    window.updateSidebarProgress = function(progress) {
        Object.keys(progress.sections).forEach(idx => {
            ...
            if (progressText) {
                progressText.textContent = sec.filled + ' / ' + sec.total;
            }
            if (progressBar) {
